...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherForm = React.createClass({
	    ...
	    onFormSubmit: function onFormSubmit(e) {
	        ...
	        var isValidLocation = location.length > 0;
	        if (!isValidLocation) {
	            return;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = "http://api.openweathermap.org/data/2.5/weather?appid=94b6558aff863cd72466b81c280d75fa&unit=imperial";
	...
	module.exports = {
	    getTemp: function getTemp(location) {
	        ...
	        return axios(requestUrl).then(function (response) {
	            var isValid = response.data.cod;
